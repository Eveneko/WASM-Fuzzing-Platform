...
(assert_invalid (module (data 0 (offset (unreachable)))) "unknown memory")
(assert_invalid
  (module (memory $0 1) (data 0 (offset (unreachable))))
  "type mismatch"
)
(assert_invalid
  (module (memory $0 1) (data 0 (offset (unreachable) (unreachable))))
